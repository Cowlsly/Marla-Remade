A privileged, encrypted backup app for your data, apps, and media

Features:
- End-to-end encryption with AES-256-GCM keyed by a 12-word recovery code (BIP-39)
- Back up to a folder (internal, USB, or SD via Storage Access Framework)
